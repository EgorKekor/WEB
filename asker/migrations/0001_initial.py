# Generated by Django 2.2 on 2019-06-23 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('likes', models.ManyToManyField(blank=True, to='asker.Like')),
                ('tags', models.ManyToManyField(blank=True, to='asker.Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('likes', models.ManyToManyField(blank=True, to='asker.Like')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='asker.Question')),
            ],
            options={
                'ordering': ['-create_date'],
            },
